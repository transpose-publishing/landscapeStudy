...
p_cols <- c("Not specified" =  "#FDE725", "Yes" = "#414487",
            "Conditional" =  "#2A788E",
...
p_cols <- c("Unsure" = "#A6761D", "Yes" = "#414487",
            "No" = "#7AD151"
)
...
p1_cols <- c("No preprint policy" =  "#FDE725", "Other" = "#666666",
...
p2_cols <- c("Not specified" =  "#FDE725", "Other" = "#666666", "Unsure" = "#A6761D",
            "Yes, in the reference list" = "#414487", 
